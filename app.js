...
async function fetchAndDisplayPatientInfo(url) {
    try {
        ...
        document.getElementById('conditions').textContent = `Address: ${addressLineAndCity}`;
        document.getElementById('medications').textContent = `State/Postal Code: ${stateAndPostalCode}`;
