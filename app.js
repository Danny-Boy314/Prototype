...
async function fetchAndDisplayPatientInfo(url) {
    try {
        ...
        document.getElementById('patient-conditions').textContent = `Conditions: ${addressLineAndCity}`;
        document.getElementById('patient-medications').textContent = `Medications: ${stateAndPostalCode}`;
